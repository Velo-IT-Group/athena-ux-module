		...
		>
			...
			<div
				className={cn(
					...
					variant === 'floating' || variant === 'inset'
						? 'p-1.5 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)_+_theme(spacing.4)_+2px)]'
	...
	({ className, asChild = false, ...props }, ref) => {
		...
		return (
			<Comp
				...
				className={cn(
					'duration-200 flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-sidebar-foreground/70 outline-none ring-sidebar-ring transition-[margin,opa] ease-linear focus-visible:ring-2 [&>svg]:size-3.5 [&>svg]:shrink-0',
	...
	return (
		<Comp
			...
			className={cn(
				...
				'peer-data-[size=lg]/menu-button:top-1.5.5',
				'group-data-[collapsible=icon]:hidden',
				showOnHover &&
...
>(({ className, showIcon = false, ...props }, ref) => {
	...
	return (
		<div
			...
			className={cn('rounded-md h-8 flex gap-1.5 px-2 items-center', className)}
			{...props}
		>
			{showIcon && (
				<Skeleton
